...
{
    public static final ResourceLocation slotTexture = new ResourceLocation("tattystorage", "textures/gui/chestSlots.png");
    public static final ResourceLocation backgroundTexture = new ResourceLocation("tattystorage", "textures/gui/chest.png");
	public static final ResourceLocation colorTexture = new ResourceLocation("tattystorage", "textures/gui/colorGrid.png");
	public static final ResourceLocation tabsTexture = new ResourceLocation("tattystorage", "textures/gui/tabs.png");
    ...
    public static void renderTabs(GuiContainer container, int rotation, int x, int y)
    {
		...
		container.drawTexturedModalRect(x, y, u, v, width, height);
    }
